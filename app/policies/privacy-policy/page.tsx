...
export const metadata = {
  ...
  description: "Privacy policy and personal data processing guidelines for Daddu Charger Gaming Store.",
};
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 sm:px-12 py-24 text-neutral-300 space-y-12 leading-relaxed">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm font-bold text-neutral-500 uppercase tracking-widest">Last updated: October 13, 2025</p>
      </div>

      <div className="space-y-8">
        <p>
          Daddu Charger operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). Daddu Charger is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
        </p>
        <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Personal Information We Collect or Process</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Personal Information Sources</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-white">How We Use Your Personal Information</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-white">How We Disclose Personal Information</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Relationship with Shopify</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Third Party Websites and Links</h2>
          <p>
            The Services may provide links to websites or other online platforms operated by third parties. If you follow links to sites not affiliated or controlled by us, you should review their privacy and security policies and other terms and conditions. We do not guarantee and are not responsible for the privacy or security of such sites, including the accuracy, completeness, or reliability of information found on these sites. Information you provide on public or semi-public venues, including information you share on third-party social networking platforms may also be viewable by other users of the Services and/or users of those third-party platforms without limitation as to its use by us or by a third party. Our inclusion of such links does not, by itself, imply any endorsement of the content on such platforms or of their owners or operators, except as disclosed on the Services. Trusted Store of Pakistan: PPG BS Verified Sellers.
          </p>
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Children's Data</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Security and Retention of Your Information</h2>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at dadduchargergs@gmail.com or contact us at Shop Lg -04 Royal Plaza 6th Road Rawalpindi, rawalpindi, 44000, PK
          </p>
        </section>
      </div>
    </main>
